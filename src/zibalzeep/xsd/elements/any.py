...
from zibalzeep.xsd.const import NotSet, xsi_ns
from zibalzeep.xsd.elements.base import Base
from zibalzeep.xsd.utils import max_occurs_iter
from zibalzeep.xsd.valueobjects import AnyObject
...
class Any(Base):
    ...
    def __init__(
        ...
        # cyclic import
        from zibalzeep.xsd import AnyType
    ...
    def render(self, parent, value, render_path=None):
        ...
        if self.accepts_multiple and isinstance(value, list):
            from zibalzeep.xsd import AnySimpleType
