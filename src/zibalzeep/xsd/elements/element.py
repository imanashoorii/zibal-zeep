...
from zibalzeep.exceptions import UnexpectedElementError
from zibalzeep.utils import qname_attr
from zibalzeep.xsd.const import Nil, NotSet, xsi_ns
from zibalzeep.xsd.context import XmlParserContext
from zibalzeep.xsd.elements.base import Base
from zibalzeep.xsd.utils import create_prefixed_name, max_occurs_iter
from zibalzeep.xsd.valueobjects import CompoundValue
...
class Element(Base):
    ...
    def signature(self, schema=None, standalone=True):
        from zibalzeep.xsd import ComplexType
